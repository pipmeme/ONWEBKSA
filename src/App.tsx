...
const PersonalLicense = lazy(() => import("./pages/PersonalLicense"));
const BankingTax = lazy(() => import("./pages/BankingTax"));
const VisasGuide = lazy(() => import("./pages/VisasGuide"));
const LegalGuide = lazy(() => import("./pages/LegalGuide"));
const FundingGuide = lazy(() => import("./pages/FundingGuide"));
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                <Route element={<Layout />}>
                  ...
                  <Route path="/startup-guide/personal-license" element={<PersonalLicense />} />
                  <Route path="/startup-guide/banking-tax" element={<BankingTax />} />
                  <Route path="/startup-guide/visas" element={<VisasGuide />} />
                  <Route path="/startup-guide/legal" element={<LegalGuide />} />
                  <Route path="/startup-guide/funding" element={<FundingGuide />} />
                  <Route path="/startup-guide/ecosystem" element={<EcosystemGuide />} />
