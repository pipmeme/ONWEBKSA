      ...
      <section className="relative overflow-hidden">
        ...
        <div className="px-4 sm:container py-16 sm:py-24 md:py-32 relative">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0}>
            ...
            >
              <ArrowLeft className="h-3.5 w-3.5" /> {t("common.backToStartupGuide")}
            </Link>
            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                <span className="flex items-center gap-1.5">
                  ...
                  <strong className="text-foreground">{totalFAQs}</strong> {t("common.questions")}
                </span>
                <span className="text-border">•</span>
                <span className="flex items-center gap-1.5">
                  <Building2 className="h-4 w-4 text-primary" />
                  <strong className="text-foreground">{categories.length}</strong> {t("common.categories")}
                </span>
                <span className="text-border">•</span>
                <span>{t("common.freeUpdated")}</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="px-4 sm:container max-w-4xl">
          {filteredCategories.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground">{t("common.noQuestionsMatch")}</p>
            </div>
          ) : (
              ...
              <div key={category.id} className="mb-12 last:mb-0">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{category.faqs.length} {t("common.questions").toLowerCase()}</p>
                  </div>
                </div>
            ...
            <div className="relative p-10 sm:p-14 text-center">
              ...
              <Button asChild size="lg" variant="outline" className="bg-white text-foreground hover:bg-white/90 border-0 px-8 h-12 shadow-xl">
                <a href="mailto:help@foundersksa.com">
                  <Mail className="mr-2 h-4 w-4" /> {t("common.askUsAnything")}
                </a>
              </Button>
            </div>
          </div>
