...
const typeKeys: Record<ProgramType, string> = {
  accelerator: "common.accelerator",
  incubator: "common.incubator",
  "venture-studio": "common.ventureStudio",
  fund: "common.fund",
};

const backingKeys: Record<BackingType, string> = {
